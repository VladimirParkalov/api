...
class sfGuardSecurityUser extends sfBasicSecurityUser
{
  ...
  {
    $referer = $this->getAttribute('referer_link', $default);
    $this->getAttributeHolder()->remove('referer_link');
  ...
  {
    if (!$this->hasAttribute('referer_link'))
    {
      $this->setAttribute('referer_link', $referer);
    }
  }
