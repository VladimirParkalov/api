...
************************************************************************************************************/	
    ...
    // No children var set ?
		...
		initTree : function()
		{
          ...
          if(this.renameAllowed)menuModel.addItem(1,'Переименовать',JSTreeObj.imageFolder +  JSTreeObj.renameIcon,'',false,'JSTreeObj.renameItem');
					if(this.deleteAllowed)menuModel.addItem(2,'Удалить',JSTreeObj.imageFolder +  JSTreeObj.deleteIcon,'',false,'JSTreeObj.deleteItem');
					if(this.addAllowed)menuModel.addItem(3,'Добавить',JSTreeObj.imageFolder +  JSTreeObj.addIcon,'',false,'JSTreeObj.addItem');
					menuModel.init();	
					
					menuModelRenameOnly = new DHTMLGoodies_menuModel();
					if(this.renameAllowed)menuModelRenameOnly.addItem(4,'Переименовать',JSTreeObj.imageFolder +  JSTreeObj.renameIcon,'',false,'JSTreeObj.renameItem');
					menuModelRenameOnly.init();
					
					menuModelDeleteOnly = new DHTMLGoodies_menuModel();
					if(this.deleteAllowed)menuModelDeleteOnly.addItem(5,'Удалить',JSTreeObj.imageFolder +  JSTreeObj.deleteIcon,'',false,'JSTreeObj.deleteItem');
					menuModelDeleteOnly.init();	 
          
          menuModelAddOnly = new DHTMLGoodies_menuModel();
          if(this.addAllowed)menuModelAddOnly.addItem(6,'Добавить',JSTreeObj.imageFolder +  JSTreeObj.addIcon,'',false,'JSTreeObj.addItem');
          menuModelAddOnly.init(); 
          
          menuModelRenameDelete = new DHTMLGoodies_menuModel();
          if(this.renameAllowed)menuModelRenameDelete.addItem(7,'Переименовать',JSTreeObj.imageFolder +  JSTreeObj.deleteIcon,'',false,'JSTreeObj.renameItem');
          if(this.deleteAllowed)menuModelRenameDelete.addItem(8,'Удалить',JSTreeObj.imageFolder +  JSTreeObj.renameIcon,'',false,'JSTreeObj.deleteItem');
          menuModelRenameDelete.init();          
          
          menuModelRenameAdd = new DHTMLGoodies_menuModel();
          if(this.renameAllowed)menuModelRenameAdd.addItem(9,'Переименовать',JSTreeObj.imageFolder +  JSTreeObj.renameIcon,'',false,'JSTreeObj.renameItem');
          if(this.addAllowed)menuModelRenameAdd.addItem(10,'Добавить',JSTreeObj.imageFolder +  JSTreeObj.addIcon,'',false,'JSTreeObj.addItem');
          menuModelRenameAdd.init();  
					
          menuModelDeleteAdd = new DHTMLGoodies_menuModel();
          if(this.deleteAllowed)menuModelDeleteAdd.addItem(11,'Удалить',JSTreeObj.imageFolder +  JSTreeObj.deleteIcon,'',false,'JSTreeObj.deleteItem');
          if(this.addAllowed)menuModelDeleteAdd.addItem(12,'Добавить',JSTreeObj.imageFolder +  JSTreeObj.addIcon,'',false,'JSTreeObj.addItem');
