...
class Addfks extends Doctrine_Migration_Base
{
    public function up()
    {
        $this->createForeignKey('music', 'music_user_id_sf_guard_user_id', array(
             'name' => 'music_user_id_sf_guard_user_id',
             'local' => 'user_id',
             'foreign' => 'id',
    ...
    {
        $this->dropForeignKey('music', 'music_user_id_sf_guard_user_id');
